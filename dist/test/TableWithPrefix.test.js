...
var TestTableWithPrefix = /** @class */ (function (_super) {
    __extends(TestTableWithPrefix, _super);
    function TestTableWithPrefix() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.tableName = 'test';
        return _this;
    }
    TestTableWithPrefix.prototype.getPrefix = function () {
...
describe('Table', function () {
    it('should generate simple select', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    testTable = new TestTableWithPrefix();
